...
11/30/25,0.951219512,,0"""
    ...
    fig.update_yaxes(title_text='Ratio', tickfont=dict(size=10), titlefont=dict(size=12), secondary_y=False)
    fig.update_yaxes(title_text='% Change Year-Over-Year', ticksuffix='%', tickfont=dict(size=10), titlefont=dict(size=12), secondary_y=True)
